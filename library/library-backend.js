  ...
  Query: {
    ...
    allBooks: (root, args) => {
      if(args.author && args.genre) {
        const booksByAuthorWithGenre = books.filter(book => book.author === args.author && book.genres.includes(args.genre))
      ...
      if(args.genre) {
        const booksWithGenre = books.filter(book => book.genres.includes(args.genre))
